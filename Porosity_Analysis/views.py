...
def porosity_view_app_report(request):
    ...
    return render(request, 'Porosity/a_porosity_viewreport.html', {'client_orders': client_orders})
...
def porosity_comp_views(request,id):
    ...
    return render(request, 'Porosity/b_porosity_app_component.html', {'components': components})



def porosity_upload_view(request):
    client_orders = Client_orders.objects.exclude(app_admin_approve=False)
    return render(request,'Porosity/c_porosity_upload_dataset.html', {'client_orders': client_orders})
...
def porosity_test(request):
    ...
    return render(request, 'Porosity/d_porosity_test_page.html', {'client_orders': client_orders})
...
def porosity_test_result(request):
    ...
    return render(request, 'Porosity/e_porosity_test_result.html', {'client_orders': client_orders})
...
def porosity_fin_report(request):
    ...
    return render(request, 'Porosity/f_porosity_final_report.html', {'client_orders': client_orders})
...
def new_test_result(request):
    ...
    return render(request, 'Porosity/g_porosity_i_test_result.html', {'client_orders': client_orders})
...
### END IMAGES
        ...
        return render(request, 'Porosity/g_porosity_i_test_result.html', {'id': id,'client_orders': client_orders})
